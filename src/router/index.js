...
export const errorRoutes = [
  ...
  /*{
    ...
    children: [
      {
        path: 'face',
        component: () => import('@/views/present/face/index'),
        name: 'face',
        meta: { title: '人脸签到', noCache: true ,icon:'people'}
      },
      {
        path: 'loca',
        component: () => import('@/views/present/location/index'),
        name: 'location',
        meta: { title: '位置签到', noCache: true, icon: 'code' }
      }
    ]
  },*/
